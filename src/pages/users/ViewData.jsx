      ...
      <div className="row">
        ...
        <div className="col-md-8 col-12">
          ...
          <SectionCard title="Personal Information" icon={<UserOutlined />}>
            ...
            <InfoRow icon={<EnvironmentOutlined />} label="Country" value={player.country} />
          ...
          <SectionCard title="Contact Information" icon={<PhoneOutlined />}>
            <InfoRow icon={<PhoneOutlined />} label="Mobile Number" value={`${player.mobile_country_code || ""} ${player.mobile || ""}`.trim()} />
          ...
          <SectionCard title="Professional Details" icon={<TrophyOutlined />}>
            ...
            <InfoRow icon={<TeamOutlined />}    label="Home Course"        value={player.home_course} />
            <InfoRow icon={<CalendarOutlined />} label="Professional Since" value={player.professional_since} />
          ...
          <SectionCard title="Identity & Banking Details" icon={<IdcardOutlined />}>
            ...
            <InfoRow icon={<TeamOutlined />} label="Bank Name" value={player.bank_name} />
            <InfoRow icon={<TeamOutlined />} label="Branch" value={player.branch || player.bank_branch} />
            <InfoRow icon={<IdcardOutlined />} label="Bank Account Number" value={player.bank_account_no} />
            <InfoRow icon={<IdcardOutlined />} label="Bank IFSC" value={player.bank_ifsc} />
          </SectionCard>

          {(player.social_facebook || player.social_twitter || player.social_instagram) && (
            <SectionCard title="Social Media" icon={<StarOutlined />}>
              <InfoRow icon={<StarOutlined />} label="Facebook" value={player.social_facebook} />
              <InfoRow icon={<StarOutlined />} label="Twitter / X" value={player.social_twitter} />
              <InfoRow icon={<StarOutlined />} label="Instagram" value={player.social_instagram} />
            </SectionCard>
          )}
