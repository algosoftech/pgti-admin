    ...
    <div className="admin-page-container">
      <div className="page-header">
        <div className="d-flex justify-content-between align-items-center">
          ...
          <button className="action-button primary" onClick={() => navigate("/admin/cms/privacy-policy/addeditdata", { state: data || {} })}>
        ...
        <div className="content-card-body">
          {isLoading ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              />
              <SectionRow
                icon={<AppstoreOutlined />} colorIdx={2} label="Content Sections"
                meta={content.sections?.length
                  ? `${content.sections.length} section${content.sections.length !== 1 ? "s" : ""} configured`
                  : "No sections added"}
                isSet={!!(content.sections?.length)}
              />
