...
const SECTION_LABELS = [
  {
    key: "header",
    label: "Page Header",
    desc: "Title and subtitle shown at the top of the Cookie Policy page",
    icon: <FontSizeOutlined />,
  },
  {
    key: "contentSections",
    label: "Policy Content Sections",
    desc: "All cookie policy sections with headings and rich-text content",
          ...
          {isLoading ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontWeight: 600, fontSize: 13, color: "#1e3a5f" }}>Cookie Policy Page</div>
              ...
              <p style={{ fontSize: 13, color: "#64748b", marginBottom: 8, marginTop: 6 }}>
                ...
                Click any Cookie Policy section below to jump straight into editing that section.
              </p>
            ...
            <div style={{ textAlign: "center", padding: "48px 20px", color: "#94a3b8" }}>
              ...
              <div style={{ fontSize: 13 }}>Click "Setup Page" to configure the Cookie Policy page.</div>
            </div>
          )}
        </div>
      </div>
