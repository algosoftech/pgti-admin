...
const SECTION_LABELS = [
  ...
  {
    key: "membersSection",
    label: "Anti-Doping Members",
    desc: "Committee tabs, member photos and Know More content",
    icon: <TeamOutlined />,
  },
  {
    key: "resourcesSection",
    label: "Anti-Doping Resources",
    desc: "Downloadable resources, PDFs and section background image",
    icon: <BookOutlined />,
  },
];
          ...
          {isLoading ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontWeight: 600, fontSize: 13, color: "#1e3a5f" }}>Anti-Doping Page</div>
              ...
              <p style={{ fontSize: 13, color: "#64748b", marginBottom: 8, marginTop: 6 }}>
                ...
                Click any Anti-Doping section below to jump straight into editing that section.
              </p>

              {/* Clickable section grid */}
