...
import {
  EditOutlined, EnvironmentOutlined, FileTextOutlined,
  InfoCircleOutlined, MessageOutlined, PictureOutlined,
  PlusOutlined,
...
const SECTION_LABELS = [
  {
    key: "heroBanner",
    label: "Hero Banner",
    desc: "Background image and title shown at the top of the Contact page",
    icon: <PictureOutlined />,
  },
  {
    key: "inquiryTabs",
    label: "Inquiry Tabs",
    desc: "Email, phone and address for each inquiry department tab",
    icon: <MessageOutlined />,
  },
  {
    key: "googleMaps",
    label: "Google Maps",
    desc: "Embed URL for the Google Maps section on the contact page",
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      const [mainRes, nextGenRes] = await Promise.all([
        listContactUs({ tour_type: "M" }),
        listContactUs({ tour_type: "F" }),
      ]);
        ...
        <div className="d-flex justify-content-between align-items-center">
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", justifyContent: "flex-end" }}>
            <button
              ...
              onClick={() => navigate("/admin/cms/contact-us/addeditdata", { state: hasMainRecord ? (hasNextGenRecord ? nextGenData : { tour_type: "F" }) : { tour_type: "M" } })}
            >
              <PlusOutlined /> {hasMainRecord ? (hasNextGenRecord ? "Edit NextGen Contact Us" : "Add NextGen Contact Us") : "Add Main Tour"}
            </button>
            <button
              className="action-button primary"
              onClick={() => navigate("/admin/cms/contact-us/addeditdata", { state: hasMainRecord ? data : (hasNextGenRecord ? nextGenData : { tour_type: "M" }) })}
            >
          ...
          {isLoading ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontWeight: 600, fontSize: 13, color: "#1e3a5f" }}>Contact Us Page</div>
              ...
              <p style={{ fontSize: 13, color: "#64748b", marginBottom: 8, marginTop: 6 }}>
                ...
                Click any Contact Us section below to jump straight into editing that section.
              </p>
          ...
          <div style={{ paddingTop: 6 }}>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, flexWrap: "wrap" }}>
              ...
              <button
                ...
                className="action-button primary"
                onClick={() =>
                  navigate("/admin/cms/contact-us/addeditdata", {
