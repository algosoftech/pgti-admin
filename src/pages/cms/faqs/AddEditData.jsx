...
const FaqAddEditPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!validateLength(formData.get('question'), 'Question', LIMITS.question)) { setIsLoading(false); return; }
      ...
      if (!validateLength(formData.get('answer'), 'Answer', LIMITS.answer)) { setIsLoading(false); return; }
  ...
  useEffect(() => {
    document.title = `PGTI || ${ADDEDITDATA?.id ? "Edit" : "Add"} FAQ`;
  }, [ADDEDITDATA?.id]);
            ...
            <div className="form-section">
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  required
                />
                <CharCounter value={ADDEDITDATA?.question} min={LIMITS.question.min} max={LIMITS.question.max} />
                <FieldHint text="Write a clear, concise question as a player or visitor would naturally ask it." />
                {error.question && (
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  required
                />
                <CharCounter value={ADDEDITDATA?.answer} min={LIMITS.answer.min} max={LIMITS.answer.max} />
                <FieldHint text="Provide a thorough, helpful answer. You may include steps, links, or examples for clarity." />
                {error.answer && (
