...
import {
  ...
  setLimit,
  setShowRequest,
} from 'store/slices/subCategories.slice';
...
export default function SubCategoryList() {
   ...
   *********************************************************/
  const getList = () => {
    const { name, category } = serverColumnFilters;
    const options = {
      type: "",
      condition: {
        ...(name ? { name: name } : null),
    ...
    dispatch(fetchSubCategoriesList(options));
  }; //End
  ...
  useEffect(() => {
    ...
    document.title = "PGTI || Admin || Sub-Category's List";
    // eslint-disable-next-line react-hooks/exhaustive-deps
